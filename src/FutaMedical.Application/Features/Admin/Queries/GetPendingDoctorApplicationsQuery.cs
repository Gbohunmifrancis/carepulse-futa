...
public record GetPendingDoctorApplicationsQuery : IRequest<ApiResponse<List<PendingDoctorApplicationDto>>>
{
}
...
public class GetPendingDoctorApplicationsQueryHandler : IRequestHandler<GetPendingDoctorApplicationsQuery, ApiResponse<List<PendingDoctorApplicationDto>>>
{
    ...
    public async Task<ApiResponse<List<PendingDoctorApplicationDto>>> Handle(GetPendingDoctorApplicationsQuery request, CancellationToken cancellationToken)
    {
        ...
        return ApiResponse<List<PendingDoctorApplicationDto>>.Ok(pendingApplications);
    }
}
