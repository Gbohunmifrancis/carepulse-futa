...
public record CreateAppointmentCommand : IRequest<ApiResponse<AppointmentResponseDto>>
{
...
public class CreateAppointmentCommandHandler : IRequestHandler<CreateAppointmentCommand, ApiResponse<AppointmentResponseDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public CreateAppointmentCommandHandler(IApplicationDbContext context, IHttpContextAccessor _httpContextAccessor)
    {
        _context = context;
        this._httpContextAccessor = _httpContextAccessor;
    }

    public async Task<ApiResponse<AppointmentResponseDto>> Handle(CreateAppointmentCommand request, CancellationToken cancellationToken)
    {
        ...
        if (student == null)
            return ApiResponse<AppointmentResponseDto>.NotFound("Student profile not found");
        ...
        if (doctor == null)
            return ApiResponse<AppointmentResponseDto>.NotFound("Doctor not found or not verified");
        ...
        return ApiResponse<AppointmentResponseDto>.Ok(dto, "Appointment request submitted successfully");
    }
}
