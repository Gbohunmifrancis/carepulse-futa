...
/// </summary>
public record UpdateStudentProfileCommand : IRequest<ApiResponse<object>>
{
...
public class UpdateStudentProfileCommandHandler : IRequestHandler<UpdateStudentProfileCommand, ApiResponse<object>>
{
    ...
    public async Task<ApiResponse<object>> Handle(UpdateStudentProfileCommand request, CancellationToken cancellationToken)
    {
        var userIdClaim = _httpContextAccessor.HttpContext?.User.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier)?.Value;
        if (string.IsNullOrEmpty(userIdClaim) || !Guid.TryParse(userIdClaim, out var userId))
            return ApiResponse<object>.BadRequest("Unauthorized");
        ...
        return ApiResponse<object>.Ok(new { }, "Profile updated successfully");
    }
}
