...
public record GetStudentProfileQuery : IRequest<ApiResponse<StudentProfileDto>>;
...
public class GetStudentProfileQueryHandler : IRequestHandler<GetStudentProfileQuery, ApiResponse<StudentProfileDto>>
{
    ...
    public async Task<ApiResponse<StudentProfileDto>> Handle(GetStudentProfileQuery request, CancellationToken cancellationToken)
    {
        ...
        if (student == null)
            return ApiResponse<StudentProfileDto>.NotFound("Student profile not found");
        ...
        return ApiResponse<StudentProfileDto>.Ok(dto, "Success");
    }
}
